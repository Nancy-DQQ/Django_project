    ...
    if request.method == 'GET':
        ...
        try:
            with transaction.atomic():
                ...
                new_user = Userprofile.objects.create(username=username, password=pm.hexdigest(),nickname=username,
                                                email=email)
...
def users_weibo_token(request):
    ...
    try:
        ...
        return JsonResponse({'code':200,'username':buser.username,'data':{'token':token}})
